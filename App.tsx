      ...
      <header id="home" className="pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 min-h-screen">
        <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
          ...
          <div className="flex justify-center lg:justify-start gap-6 pt-4">
            <a href={DEVELOPER_INFO.github} className="text-slate-500 hover:text-white transition-colors"><Github size={24} /></a>
            <a href={DEVELOPER_INFO.linkedin} className="text-slate-500 hover:text-white transition-colors"><Linkedin size={24} /></a>
            <a href={DEVELOPER_INFO.twitter} className="text-slate-500 hover:text-white transition-colors"><Twitter size={24} /></a>
            <a href={`mailto:${DEVELOPER_INFO.email}`} className="text-slate-500 hover:text-white transition-colors"><Mail size={24} /></a>
          </div>
        </div>
        
        <div className="lg:w-1/2 relative">
          <div className="absolute -inset-10 bg-indigo-500/20 blur-[100px] rounded-full"></div>
          <div className="relative bg-slate-900 border border-slate-800 rounded-3xl p-8 overflow-hidden shadow-2xl group">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="p-8 bg-slate-900 border border-slate-800 rounded-2xl hover:border-indigo-500/50 transition-all hover:shadow-xl hover:shadow-indigo-500/5 group">
            <div className="w-12 h-12 rounded-xl bg-slate-950 flex items-center justify-center mb-6 border border-slate-800 group-hover:scale-110 transition-transform">
              {item.icon}
            </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
               ...
               {[
                 ...
                 <button 
                  key={q} 
                  className="w-full text-left p-4 rounded-xl border border-slate-800 hover:border-indigo-500/30 hover:bg-slate-900 transition-all text-sm text-slate-400 hover:text-white"
                >
                   {q}
                 </button>
               ))}
