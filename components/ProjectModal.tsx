  ...
  return (
    ...
    >
      ...
      >
        ...
        <button 
          onClick={onClose}
          className="absolute top-6 right-6 p-2 bg-slate-950/50 hover:bg-slate-800 text-white rounded-full transition-colors z-10"
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 space-y-8">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a 
                ...
                className="flex-1 min-w-[140px] px-6 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl transition-all shadow-xl shadow-indigo-600/20 flex items-center justify-center gap-2"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex-1 min-w-[140px] px-6 py-4 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2"
              >
